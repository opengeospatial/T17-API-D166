...
class Controller {
  ...
  */
  ...
  static async handleRequest(request, response, serviceOperation) {
    try {
      console.log("serviceOperation=");
      console.log(serviceOperation);
      let reqparams=this.collectRequestParams(request);
      ...
      if (mtype===undefined || mtype===null){
        ...
        writer.sendResponse(request, response, serviceResponse, serverConfig.payload.server, reqparams);
      }
    } catch (error) {
