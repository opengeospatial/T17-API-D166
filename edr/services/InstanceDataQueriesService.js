...
* */
const getInstanceDataForArea = ({ collectionId, instanceId, coords, z, datetime, parameterName, resolutionX, resolutionY, crs, f }) => new Promise(
...
* returns coverageJSON
* */
const getInstanceDataForCorridor = ({ collectionId, instanceId, coords, corridorWidth, widthUnits, corridorHeight, heightUnits, z, datetime, parameterName, resolutionX, resolutionZ, crs, f }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        collectionId,
...
* returns coverageJSON
* */
const getInstanceDataForCube = ({ collectionId, instanceId, bbox, z, datetime, parameterName, crs, f }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        collectionId,
...
* returns coverageJSON
* */
const getInstanceDataForLocation = ({ collectionId, instanceId, locId, datetime, crs, f }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        collectionId,
...
* returns coverageJSON
* */
const getInstanceDataForPoint = ({ collectionId, instanceId, coords, z, datetime, parameterName, crs, f }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        collectionId,
...
* returns coverageJSON
* */
const getInstanceDataForRadius = ({ collectionId, instanceId, coords, within, withinUnits, z, datetime, parameterName, crs, f }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        collectionId,
...
* returns coverageJSON
* */
const getInstanceDataForTrajectory = ({ collectionId, instanceId, coords, z, datetime, parameterName, crs, f }) => new Promise(
  async (resolve, reject) => {
    try {
      resolve(Service.successResponse({
        collectionId,
